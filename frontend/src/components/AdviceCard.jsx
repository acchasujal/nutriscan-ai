  ...
  return (
    <div className="layout-container" style={{ gridTemplateColumns: '1fr 1fr', gap: '1.5rem', marginTop: '1.5rem', display: 'grid' }}>
      ...
      <div className="card" style={{ padding: '1.5rem', borderLeft: '4px solid var(--primary)' }}>
        ...
        <p style={{ fontSize: '0.78rem', color: 'var(--text-muted)', marginTop: '1rem', paddingTop: '1rem', borderTop: '1px solid var(--border-color)' }}>
          These nutrition numbers are visual estimates, not medical measurements. Confidence: {confidence ? `${Math.round(confidence * 100)}%` : 'n/a'}.
        </p>
      </div>
    </div>
  );
